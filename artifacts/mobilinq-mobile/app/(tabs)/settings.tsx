...
export default function SettingsScreen() {
  const colors = useColors(); const insets = useSafeAreaInsets(); const queryClient = useQueryClient(); const session = useGetAuthSession(); const settings = useGetSettings(); const stores = useGetStores(); const current = useGetCurrentStore(); const select = useSetCurrentStore(); const logout = useLogoutEmployee(); const [message, setMessage] = useState(''); const { t } = useLocale();
